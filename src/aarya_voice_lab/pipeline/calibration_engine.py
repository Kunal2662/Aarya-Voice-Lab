...
HARDWARE_DETECTION_LIMITATION = (
    ...
    "nvidia-smi, AMD via rocm-smi, any other vendor via a PCI-id sysfs "
    "enumeration on Linux, or a Windows WMI enumeration on Windows (see "
    "environment.audit.check_accelerator, system_info._detect_gpu_via_sysfs, "
    "system_info._detect_gpu_via_windows_wmi) -- none needing a vendor "
    "tool installed. What is still NOT detected is whether a matching compute RUNTIME "
